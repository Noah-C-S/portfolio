...
window.addEventListener('DOMContentLoaded', function(){
    ...
    footerEl.addEventListener('click', function(){if(NUMLINES < 8) NUMLINES++; if(!hidden) {$("#footerContent").hide(); $("#draw").show(); fix(); hidden = true;} if(NUMLINES> 0) $("#draw").css("cursor", "none");});
